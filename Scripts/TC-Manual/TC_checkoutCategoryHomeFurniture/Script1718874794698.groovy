...
Mobile.verifyElementVisible(findTestObject('product page/product name/textbtn_copper'), 0)

Mobile.tap(findTestObject('product page/product name/textbtn_copper'), 0)
